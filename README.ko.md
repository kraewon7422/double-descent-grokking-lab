...
![더블 디센트 · 그로킹 실험실](screenshot.png)

---

## 🔬 지금 바로 실행하기

- **온라인 데모 (한국어):** https://kraewon7422.github.io/double-descent-grokking-lab/
- **온라인 데모 (English):** https://kraewon7422.github.io/double-descent-grokking-lab/index.en.html
...
```
index.html                     # 한국어 버전 (GitHub Pages 진입점)
index.en.html                  # 영어 버전
